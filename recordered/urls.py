...
urlpatterns = [
    ...
    path('private-teaching/', include('apps.practice.urls')),
    path('private-teaching/', include('apps.exams.urls')),
    path('private-teaching/', include('apps.scheduling.urls')),
    path('private-teaching/', include('apps.quizzes.urls')),
