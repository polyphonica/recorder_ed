"""
State-only migration: register TeacherAvailability, AvailabilityException,
TeacherAvailabilitySettings in the scheduling app.

The underlying tables are:
  'private_teaching_teacher_availability'
  'private_teaching_availability_exception'
  'private_teaching_availability_settings'
(all unchanged — no database operations performed)
"""
            ...
            state_operations=[
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('max_recurring_lessons', models.IntegerField(default=8, help_text="Maximum number of lessons students can book in a recurring sequence (e.g., 8 = up to 8 weekly lessons)")),
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('exception_type', models.CharField(
                            choices=[('block', 'Block Time (Unavailable)'), ('available', 'Add Availability (Override)')],
                            default='block',
