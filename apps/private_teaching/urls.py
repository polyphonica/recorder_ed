...
urlpatterns = [
    ...
    path('teacher/settings/reminders/', views.ReminderSettingsView.as_view(), name='reminder_settings'),
    ...
    path('teacher/library/urls/add/', views.add_standalone_url, name='standalone_url_add'),
    path('teacher/library/urls/<uuid:pk>/edit/', views.edit_standalone_url, name='standalone_url_edit'),
    path('teacher/library/urls/<uuid:pk>/delete/', views.delete_standalone_url, name='standalone_url_delete'),
