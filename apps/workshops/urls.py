...
urlpatterns = [
    ...
    path('instructor/workshop/<slug:slug>/duplicate/', views.DuplicateWorkshopView.as_view(), name='duplicate_workshop'),
    path('instructor/workshop/<slug:slug>/toggle-publish/', views.TogglePublishView.as_view(), name='toggle_publish'),
    ...
    path('instructor/session/<uuid:session_id>/cancel/', views.CancelSessionView.as_view(), name='cancel_session'),
    path('instructor/session/<uuid:session_id>/delete/', views.DeleteSessionView.as_view(), name='delete_session'),
    ...
    path('instructor/session/<uuid:session_id>/take-attendance/',
    ...
    path('cart/add-series/<uuid:workshop_id>/', views.AddSeriesToCartView.as_view(), name='add_series_to_cart'),
