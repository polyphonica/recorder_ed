    ...
    def get_context_data(self, **kwargs):
        ...
        context['faqs'] = [
            ...
            },
            {
                ...
                'answer': 'Both options are available! For <strong>private lessons</strong>, each teacher sets their preferences - online via Zoom or in-person at their studio. <strong>Workshops</strong> can be held online or in-person, as specified in the workshop details. <strong>Online courses</strong> are entirely self-paced and accessible from anywhere.'
            },
            {
